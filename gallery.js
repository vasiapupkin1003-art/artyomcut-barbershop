...
const defaultPhotos = [
    {
        src: 'images/works/work-1.jpeg',
        alt: 'Работа 1',
        category: 'fade'
    },
    {
        src: 'images/works/work-2.jpeg',
        alt: 'Работа 2',
        category: 'classic'
    },
    {
        src: 'images/works/work-3.jpeg',
        alt: 'Работа 3',
        category: 'beard'
    },
    {
        src: 'images/works/work-4.jpeg',
        alt: 'Работа 4',
        category: 'fade'
    }
];

// Загружаем фото из localStorage или используем стандартные
let galleryPhotos = JSON.parse(localStorage.getItem('galleryPhotos') || 'null');
...
// Текущий индекс открытой фотографии
